...
%>
  ...
  # the recipes are monit, nginx, and depending on the stack passenger6, puma, or unicorn
  app.recipes.each do |recipe|
    ...
    next unless ["puma", "nginx", "monit", "mysql", "postgresql", "unicorn", "puma_legacy", "passenger6"].include?("#{recipe}")
