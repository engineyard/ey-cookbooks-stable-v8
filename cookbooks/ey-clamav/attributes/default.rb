...
# NOTE: the clamav-daemon version pin was removed (install.rb now installs the
# release default). It was a Focal-only package version that does not resolve
# on Noble / Ubuntu 24.04.
